...
{
    cpToTmp();
    QString path = "/opt/durapps/fantascene-archLinux-DDE/";
...
//    a.setTheme("light");
    ...
    if (a.setSingleInstance("fantascene-archLinux-DDE")) {
        ...
        dApp->m_startDesktop  = QThread::create([ = ]() {
            ...
            if (QFileInfo(path + "dde-desktop").isFile()) {
                ...
                dApp->m_startDesktopProcess->start("bash /opt/durapps/fantascene-archLinux-DDE/startdesktop.sh");
